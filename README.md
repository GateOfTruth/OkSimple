...
### 项目介绍
基于okhttp的二次封装库。基于okhttp4.X和kotlin，目前更新到okttp4.9。设计之初有参考[okgo](https://github.com/jeasonlzy/okhttp-OkGo)，最后都是采用链式调用加回调的方式。但和okgo对比的话，不管是代码还是思路，都是完全不同的。觉得好用的话，给个star吧，也欢迎提issue，pr或者其他建议。
