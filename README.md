...
### 项目介绍
强大好用的网络请求框架。基于okhttp5.X和kotlin，目前少有的更新到okttp5.X的网络请求框架。当前版本是okttp5.0.0-alpha.12。采用链式回调，不用再写一堆接口和类，轻量级，扩展性强，欢迎star，也欢迎提issue，pr或者其他建议。
...
然后在app的build.gradle
```
implementation 'com.github.GateOfTruth:OkSimple:3.4.2'
```
